...
client.on('guildCreate', guild => {
    ...
    .setDescription(`***مشكور ياحبي لانك دخلتني في سيرفرك فيني اخدمك الان***`)                      
              .setFooter(`bot arab`, 'https://cdn.discordapp.com/attachments/387286451034783744/388013469275914240/thesilent_1x.jpg')
...
client.on('ready', () => { //code bot not leave room voice //Bot Is Online
    client.channels.get("512752615864533007").join(); //by :n3k4a 
    });
